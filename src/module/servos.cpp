...
void stand(void) {
    ...
    set_site(1, KEEP, KEEP, z_default-z_noise);
    set_site(2, KEEP, KEEP, z_default-z_noise);
...
void turn_left(unsigned int step) {
    ...
    while (step-- > 0) {
        ...
        if (sst.site_now[3][1] == y_start) {
            ...
            set_site(1, turn_x0 - x_offset, turn_y0, z_default-z_noise);
            set_site(2, turn_x1 + x_offset, turn_y1, z_default-z_noise);
            ...
            set_site(2, x_default - x_offset, y_start + y_step, z_default-z_noise);
            set_site(3, x_default - x_offset, y_start + y_step, z_default);
            wait_all_reach();

            set_site(1, x_default + x_offset, y_start, z_default-z_noise);
            wait_all_reach();
        } else {
            //leg 0&2 move
            ...
            set_site(1, turn_x1 + x_offset, turn_y1, z_default-z_noise);
            set_site(2, turn_x0 - x_offset, turn_y0, z_default-z_noise);
            ...
            set_site(1, x_default - x_offset, y_start + y_step, z_default-z_noise);
            set_site(2, x_default + x_offset, y_start, z_up);
            set_site(3, x_default + x_offset, y_start, z_default);
            wait_all_reach();

            set_site(2, x_default + x_offset, y_start, z_default-z_noise);
            wait_all_reach();
        }
    }
}
...
//      Serial.println("PCA9685 Servo Test");
        if (sst.site_now[2][1] == y_start) {
            ...
            wait_all_reach();
            set_site(2, x_default + x_offset, y_start + 2 * y_step, z_default-z_noise);
            wait_all_reach();

            move_speed = body_move_speed;

            set_site(0, x_default + x_offset, y_start, z_default);
            set_site(1, x_default + x_offset, y_start + 2 * y_step, z_default-z_noise);
            set_site(2, x_default - x_offset, y_start + y_step, z_default-z_noise);
            set_site(3, x_default - x_offset, y_start + y_step, z_default);
            wait_all_reach();
